<div id="sidebar">
  <ul>
    ...
    <li class="submenu">
      <a href="#"><i class="icon icon-th-list"></i> <span>Catalogues</span></a>
      <ul>
        <li class="submenu">
          <a href="#"><i class="icon icon-th"></i> Catégorie</a>
          <ul>
        ...
        <li class="submenu">
          <a href="#"><i class="icon icon-th-large"></i> Sous-catégorie</a>
          <ul>
        ...
        <li class="submenu">
          <a href="#"><i class="icon icon-tag"></i> Marque</a>
          <ul>
        ...
        <li class="submenu">
          <a href="#"><i class="icon icon-barcode"></i> Produit</a>
          <ul>
    ...
    <!-- Fournisseurs -->
    <li class="submenu">
      <a href="#"><i class="icon icon-truck"></i> <span>Fournisseurs</span></a>
      <ul>
    ...
    <!-- Clients -->
    <li class="submenu">
      <a href="#"><i class="icon icon-user"></i> <span>Clients</span></a>
      <ul>
    ...
    <!-- Transactions -->
    <li class="submenu">
      <a href="#"><i class="icon icon-exchange"></i> <span>Transactions</span></a>
      <ul>
    ...
    <!-- Rapports -->
    <li class="submenu">
      <a href="#"><i class="icon icon-file"></i> <span>Rapports</span></a>
      <ul>
    ...
    <li><a href="search.php"><i class="icon-search"></i> <span>Recherche</span></a></li>
  </ul>
</div>